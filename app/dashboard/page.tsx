...
export default async function DashboardPage() {
  ...
  const [leavesRes, tasksRes, emergRes, muraRes, arzRes, pollsRes, assetsRes, docsRes, lmsRes, attendRes] = await Promise.all([
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#F0F4FF" }}>
      ...
      <div className="max-w-4xl mx-auto px-4 -mt-4">
        <div className="grid grid-cols-4 sm:grid-cols-11 gap-2 mb-6">
          {[
